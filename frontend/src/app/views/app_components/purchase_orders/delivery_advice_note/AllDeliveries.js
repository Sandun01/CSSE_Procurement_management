...
class AllDeliveries extends Component {
    ...
    getAllData = async () => {
        await DeliveryAdviceNoteServices.getDeliveryNotesByUserID()
            .then((res) => {
                console.log(res)
                if (res.success) {
                    console.log(res)
                    this.setState({
                        notes_data: res.notes,
                        loading: false,
                    })
                } else {
                    this.setState({
                            ...
                            <div className="w-full overflow-auto">
                                ...
                                >
                                                        ...
                                                        <TableCell align="center">
                                                            ...
                                                            >
                                                                <VisibilityIcon
                                                                    ...
                                                                    onClick={() =>
                                                                        window.open(
                                                                            `/delivery_advice_notes/view/${item._id}`
                                                                        )
                                                                    }
                                                                />
                                                            </Tooltip>
                                    ...
                                    <TablePagination
                                        ...
                                        component="div"
                                        count={this.state.notes_data.length}
...
export default withStyles(styles)(AllDeliveries)
